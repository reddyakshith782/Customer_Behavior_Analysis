...
> An end-to-end Data Analytics project that analyzes customer shopping behavior using **Python, PostgreSQL, and Power BI** to uncover purchasing trends, customer segments, and business insights.
